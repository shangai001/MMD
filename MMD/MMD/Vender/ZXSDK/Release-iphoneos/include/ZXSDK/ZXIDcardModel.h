 ...
 *
 */
-(void)get_front_faceImg_user:(ZXImageHandler)imageHander;          //获得身份证正面人脸图像（用户自己拍照上传的）
-(void)get_front_faceImg_official:(ZXImageHandler)imageHander;      //获得身份证正面人脸图像（公安部的数据）
-(void)get_front_img:(ZXImageHandler)imageHander;                   //获得身份证正面图片
-(void)get_back_img:(ZXImageHandler)imageHander;                    //获得身份证背面图片
@end
